...
function  create() {
    ...
    kd.href = 'https://xn--kiv39c36evrb.eu.org/url/index.php?id='+myid.value+'&url='+url.value; //修改此处的域名 必须要SSL证书
    kd.style = ''; 
    kd.innerText = 'https://xn--kiv39c36evrb.eu.org/url/index.php?id='+myid.value+'&url='+url.value; //修改此处的域名  必须要SSL证书  
}
</script>
<div id="bob">
...
④我再说一遍,填写要么数字要么QQ,小学生滚,写你*英文和中文呢？  
